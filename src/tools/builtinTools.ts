...
- Pass vault-relative paths without a leading slash. If a call fails, adjust the path (for example, add ".md"/".canvas" or use an alternative candidate) and retry only if necessary.
